...
const AnalysisReport: React.FC<AnalysisReportProps> = ({ report }) => {
  ...
  return (
    <div className="h-full flex flex-col bg-slate-50 font-sans print-report">
      ...
      <div className="hidden print:block mb-6 pb-4 border-b-2 border-slate-800">
        <h2 className="text-3xl font-bold text-slate-900 bangla-text">জমি চেক রিপোর্ট</h2>
        <p className="text-sm text-slate-600 mt-1">Generated by JomiCheck AI • Pro Grade Analysis</p>
        <p className="text-xs text-slate-500 mt-2">Date: {new Date().toLocaleDateString('en-BD', { year: 'numeric', month: 'long', day: 'numeric' })}</p>
      </div>
